...
Use template from `/home/milgraph/Projects/algo/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/milgraph/Projects/algo/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/milgraph/Projects/algo/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
