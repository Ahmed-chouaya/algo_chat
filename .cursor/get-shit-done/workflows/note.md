...
- **Global scope**: `/home/milgraph/Projects/algo/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/milgraph/Projects/algo/.cursor/notes/`)
...
2. Glob `/home/milgraph/Projects/algo/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/home/milgraph/Projects/algo/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/milgraph/Projects/algo/.cursor/notes/` — works in any directory
